cmd_scripts/dtc/checks.o := clang -Wp,-MD,scripts/dtc/.checks.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -I ../scripts/dtc/libfdt -DNO_YAML -c -o scripts/dtc/checks.o ../scripts/dtc/checks.c
