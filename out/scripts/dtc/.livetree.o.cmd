cmd_scripts/dtc/livetree.o := clang -Wp,-MD,scripts/dtc/.livetree.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -I ../scripts/dtc/libfdt -DNO_YAML -c -o scripts/dtc/livetree.o ../scripts/dtc/livetree.c
